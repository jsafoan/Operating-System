...
typedef union idt_desc_t {
    uint32_t val[2];
    struct {
        uint16_t offset_15_00;// offset bits 0..15
        uint16_t seg_selector;// a code segment selector in GDT or LDT
        uint8_t  reserved4;// bits 0..2 holds Interrupt Stack Table offset, rest of bits zero.
